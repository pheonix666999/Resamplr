...
- `windows-x64` on Windows 2025: Debug build/CTest plus Release standalone/VST3, processor and app
  smoke, static-runtime dependency inspection, and unsigned development archive.
- `macos-universal` on macOS 15 arm64: universal Release standalone/VST3/AU, tests, processor/app
  smoke, `lipo`, `auval`, and unsigned archive.
